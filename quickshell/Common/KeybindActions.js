...
const DMS_ACTIONS = [
    ...
    { id: "spawn dms ipc call clipboard-actions toggle", label: "Clipboard Actions: Toggle" },
    { id: "spawn dms ipc call clipboard-actions open", label: "Clipboard Actions: Open" },
    { id: "spawn dms ipc call clipboard-actions close", label: "Clipboard Actions: Close" },
